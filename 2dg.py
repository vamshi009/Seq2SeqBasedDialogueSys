    ...
    with torch.no_grad():
        ...
        for di in range(max_length):
            ...
            if topi.item() == EOS_token:
                ...
                '''print("getting the output word from here\n")
                print(topi.item())'''
...
trainIters(encoder1, attn_decoder1, 62000, print_every=1000)
...
evaluateAndShowAttention(" sweet joey love")
evaluateAndShowAttention(" have fun tonight")
